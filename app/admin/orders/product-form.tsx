                ...
                <div className="upload-field">
                    ...
                    <Card>
                        <CardContent className='space-y-2 mt-2'>
                            ...
                            {isFeatured && !banner && (
                                // Upload Button & Upload space drag n drop
                                <></>
                            )}
                        </CardContent>
                    </Card>
...
export function ProductFormUpdate({ product, productId }: { product?: Product, productId?: string }) {
    const router = useRouter();
    ...
    return (
        <Form {...form}>
            <form method='POST' onSubmit={form.handleSubmit(onSubmitUpdate)} className="space-y-8">
                <div className="flex flex-col md:flex-row gap-5 items-start">
                    {/* Name */}
                    <FormField control={form.control} name="name"
